...
class TheConsolationOfPhilosophy(BaseBook):
    base_dir = os.path.join("external", "the-consolation-of-philosophy")
    chapters_dir = os.path.join(base_dir, "chapters")

    def __init__(self):
        super().__init__("the-consolation-of-philosophy")
    ...
    def get_extra_pandoc_options(self, format):
        return "-f markdown+hard_line_breaks"
