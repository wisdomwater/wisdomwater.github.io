...
% --- TOC formatting: hide sections, show subsections with page numbers ---
% Use titletoc/tocloft to customize the table of contents.
\usepackage{titletoc}
\usepackage{tocloft}
% Remove (suppress) section (H2 / `##`) entries from the TOC entirely
\titlecontents{section}
  ...
  {}%
  {}%
% Show subsection (H3 / `###`) entries and their page numbers
\titlecontents{subsection}
  [2.5em]
  {\addvspace{1pt}}%
  {\contentslabel{2.5em}}%
  {}%
  {\hfill\contentspage}% show page numbers for `subsection` (H3/###)
...
% Turn off page numbers for subsection entries in the TOC
